...
function add_undesign_js() {
	if (!is_admin()) { //only add scripts on non-admin pages
		...
		wp_enqueue_script('analytics', get_template_directory_uri() . '/js/google-analytics.js', array(), false, true);
    wp_enqueue_script('disqus-comment-count', get_template_directory_uri() . '/js/disqus-comment-count.js', array(), false, true);
	}
}
...
function theme_styles() {
    ...
    wp_register_style('bootstrap', get_template_directory_uri() . '/css/bootstrap/bootstrap.min.css', array(), false, 'all');
		...
		wp_register_style('undesign', get_template_directory_uri() . '/style.css', array(), false, 'all');
